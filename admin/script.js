const names = [
  { id: '0', names: 'Общее' },
  { id: '1', names: 'Дорогие Артём и Татьяна' },
  { id: '2', names: 'Дорогие Витя и Рита' },
  { id: '3', names: 'Дорогие Лёша и Катя' },
  { id: '4', names: 'Дорогие дядя Серёжа, тётя Лена и Януля' },
  { id: '5', names: 'Ольга и Евгений' },
  { id: '6', names: 'Любимая тётя Галя' },
];
